        ...
        <div css={section}>
          ...
          <div>
            <ul>
              ...
              <li>
                Facilitating clarity in stakeholder requirements by leading the team around best practices throughout
                the entire software
              ...
              <li>
                Optimize data retrieval for the unique and varied needs of stakeholders and customers by utilizing a
                diversified set of
                databases such as SQL, DynamoDB, and Elasticsearch
              </li>
              <li>
                Letting customers take control of their data by implementing a public facing restful API abstracting out
                multiple complex
                microservices
              </li>
          ...
          <div>
            <div css={jobHeading}>
              ...
              <div css={jobRole}>
                ...
                <div>January 2019 to November 2023</div>
              </div>
            </div>
            <div>
              <ul>
                ...
                <li>
                  Lead the elevation of coding standards through code toggles and automated testing, which accelerated
                  the speed and
                  reliability of deploys and changes by 300%
                </li>
                <li>
                  Develop new microservices unlocking a total addressable market of $9 billion in the Product
                  Information Management industry
                </li>
                <li>Enhanced developer experience by leveraging TypeScript and Emotion Js to pursue type safe, quality
                  code
                </li>
                <li>Provide users with quick search results with DynamoDb, mySql, and Elasticsearch</li>
                <li>
                  Increase customer trust in data integrity by maintaining, enhancing, and working in an Event Sourced
                  system utilizing
                ...
                <li>Create searchable and digestible documentation for stakeholders and developers in Confluence and
                  Jira
                </li>
              </ul>
            </div>
          ...
          <div>
            ...
            <div>
              <ul>
                ...
                <li>Created searchable and digestible documentation for stakeholders and developers in Confluence and
                  Jira
                </li>
                <li>
                  Reviewed code security audits, prioritized issues with stakeholders, and remediated security issues
                  and concerns as team
                  Security Advisor
                </li>
                <li>
                  Audited, prioritized issues with stakeholders, and remedied accessibility issues to maintain section
                  508 accessibility
          ...
          <div>
            ...
            <div>
              <ul>
                ...
                <li>
                  Optimized data retrieval for the unique and varied needs of stakeholders and customers by designing
                  and implementing
                  normalized transactional SQL database and SQL data mart
                </li>
                <li>Designed and implemented a customizable and predictive vaccine ordering system optimizing customer's
                  workflow
                </li>
                <li>
                  Allowed real-time vaccine registry updates through implementing SOAP web service minimizing reporting
                  delay and
                  deduplication issues
                </li>
                <li>Let customers query vaccination statistics by implementing pdf reports with JasperReports and
                  iReports
                </li>
              </ul>
            </div>
